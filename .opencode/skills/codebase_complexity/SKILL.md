...
description: Specialized instruction set for executing the Codebase Complexity workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Codebase Complexity

## Overview
This skill provides the rigid framework required to execute the `codebase_complexity` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
