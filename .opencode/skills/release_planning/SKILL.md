...
description: Specialized instruction set for executing the Release Planning workflow.
version: 1.0.0
...
## Overview
This skill provides the rigid framework required to execute the `release_planning` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
