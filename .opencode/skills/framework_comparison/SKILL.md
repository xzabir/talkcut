...
description: Specialized instruction set for executing the Framework Comparison workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Framework Comparison

## Overview
This skill provides the rigid framework required to execute the `framework_comparison` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
