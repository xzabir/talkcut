---
name: contributor_guide_generation
description: Specialized instruction set for executing the Contributor Guide Generation workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Contributor Guide Generation

## Overview
This skill provides the rigid framework required to execute the `contributor_guide_generation` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
