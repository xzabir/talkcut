---
name: repo_health_scoring
description: Specialized instruction set for executing the Repo Health Scoring workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Repo Health Scoring

## Overview
This skill provides the rigid framework required to execute the `repo_health_scoring` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
