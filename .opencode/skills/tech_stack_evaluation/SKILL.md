---
name: tech_stack_evaluation
description: Specialized instruction set for executing the Tech Stack Evaluation workflow.
version: 1.0.0
...
## Overview
This skill provides the rigid framework required to execute the `tech_stack_evaluation` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
