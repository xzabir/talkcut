...
description: Specialized instruction set for executing the Ai Model Evaluation workflow.
version: 1.0.0
...
## Overview
This skill provides the rigid framework required to execute the `ai_model_evaluation` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
