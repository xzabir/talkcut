...
description: Specialized instruction set for executing the Performance Bottleneck workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Performance Bottleneck

## Overview
This skill provides the rigid framework required to execute the `performance_bottleneck` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
