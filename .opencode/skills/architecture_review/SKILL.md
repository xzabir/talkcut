...
description: Specialized instruction set for executing the Architecture Review workflow.
version: 1.0.0
...
## Overview
This skill provides the rigid framework required to execute the `architecture_review` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
