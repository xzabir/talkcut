---
name: feature_gap_discovery
description: Specialized instruction set for executing the Feature Gap Discovery workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Feature Gap Discovery

## Overview
This skill provides the rigid framework required to execute the `feature_gap_discovery` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
