...
description: Specialized instruction set for executing the Market Sentiment Analysis workflow.
version: 1.0.0
author: Deep Agents Org
---

# Skill: Market Sentiment Analysis

## Overview
This skill provides the rigid framework required to execute the `market_sentiment_analysis` task at a world-class level. When an agent invokes this skill, they must follow every constraint and execution step precisely.
